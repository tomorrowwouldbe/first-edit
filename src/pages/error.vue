                            ...
                            <li v-for="(item, index2) in good.items" :key="index2">
                                ...
                                <div>        
                                    <div :class="{pop: true, mov: item.num>0}">
										...
										<img src="../assets/minus-circle.png" style="width:20px;height:20px;border-radius:50%" @click="reduce(index1, index2)" />
                                        {{item.num}}
                                    </div>
                                    
									<img src="../assets/plus-circle.png" style="width:20px;height:20px;border-radius:50%" @click="increase(index1, index2, $event)" />
                                </div>
                            </li>
                        </ul>
                    </li> 
